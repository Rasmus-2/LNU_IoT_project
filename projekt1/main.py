...
def measure_temp_hum():
    ...
    try:
        ...
        print("Publishing: {0} to {1} ... ".format(temperature, keys.AIO_TEMP_LIVING_ROOM), end='')
        client.publish(topic=keys.AIO_TEMP_LIVING_ROOM, msg=str(temperature))
        print("DONE")

        print("Publishing: {0} to {1} ... ".format(humidity, keys.AIO_HUM_LIVING_ROOM), end='')
        client.publish(topic=keys.AIO_HUM_LIVING_ROOM, msg=str(humidity))
        print("DONE")
